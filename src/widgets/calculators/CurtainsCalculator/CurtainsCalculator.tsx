    ...
    return (
        <div className="pt-[60px] pb-[20px] max-sm:pt-[20px] ms-auto me-auto max-w-[750px] px-[20px]">
            ...
            <article className="pb-[40px]">
                ...
                <strong className="font-semibold">При определении ширины занавесей следует принимать во внимание несколько ключевых факторов:</strong>
                <p className="mt-[15px]">
                ...
                <p className="mt-[15px]">
                    ...
                    <span className="block ps-[20px] mb-[4px] text-neutral-600">
                        <b>Карандашные складки или буфы</b> - <b>2-2,5</b>, с добавлением примерно 20 см с каждой стороны в зависимости от количества
                        складок.
                    </span>
                </p>
